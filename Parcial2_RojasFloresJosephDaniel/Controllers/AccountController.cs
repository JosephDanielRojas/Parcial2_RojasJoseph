...
using Parcial2_RojasFloresJosephDaniel.Models;
using Parcial2_RojasFloresJosephDaniel.Providers;
using Parcial2_RojasFloresJosephDaniel.Results;

namespace Parcial2_RojasFloresJosephDaniel.Controllers
{
    [Authorize]
