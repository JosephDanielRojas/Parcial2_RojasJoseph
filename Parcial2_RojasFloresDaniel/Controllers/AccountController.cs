...
using Parcial2_RojasFloresDaniel.Models;
using Parcial2_RojasFloresDaniel.Providers;
using Parcial2_RojasFloresDaniel.Results;

namespace Parcial2_RojasFloresDaniel.Controllers
{
    [Authorize]
